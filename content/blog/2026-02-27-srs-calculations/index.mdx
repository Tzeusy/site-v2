...
2. No platform fee erosion (assumes the same 7% return both in and outside of SRS) - **this explains the main difference in recommendations**
...
- You want your money going to `{platform, e.g. Endowus}` instead of the Government
...
Having taken these factors into account, none of those scenarios apply to me; hence I decided I won't be leveraging SRS in own personal investment strategy, given the significant downsides and negligible upside.
