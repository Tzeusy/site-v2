...
<ExcalidrawDiagram light="amenities-light.svg" dark="amenities-dark.svg" alt="Amenities data ingestion flow" />
...
<ExcalidrawDiagram light="geocoding-light.svg" dark="geocoding-dark.svg" alt="Geocoding pipeline flow" />
...
![Heatmaps overlaid over Singapore aren't entirely new - NEA-MSS Rain Cloud Visualization](nea-mss-rain.png)
...
![Radar Charts for User Preferences](radar-chart.png)
...
![If you only care about living near police stations...](police-station-heatmap.png)

![Or if you only care about hawker centres...](hawker-centre-heatmap.png)
...
![My Personal Matrix](personal-heatmap-matrix.png)
...
![Or if you are hunting for locations near good primary schools (Please don't judge me, MOE)...](good-primary-schools.png)
...
![OneMap giving me Killiney as the first result for 'Changi General Hospital'...](cgh-in-somerset.png)

![AI thinking my primary school is Tier 3 :-(](ai-primary-school-tier.png)
