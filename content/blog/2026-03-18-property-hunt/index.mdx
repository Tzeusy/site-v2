...
![A problem we often faced was how to quickly view recent transactions for any given property, as a way for us to quickly benchmark historical rental prices. We now have a quick way to look that up!](transaction-tooltip.png)
...
![OneMap giving me Killiney as the first result for 'Changi General Hospital'...](cgh-in-somerset.png?size=100)
