...
4. Experimentation
    - Corporate infrastructure is often months or even years behind the latest generations of industry offerings, due to bureaucracy, legacy code, and simply misaligned incentives. It takes months for me to get a Python packaged approved internally within the firm, and that's *pre-validation* when I can't guarantee the potential benefits; how else am I to understand new libraries and offerings?
    - Most recently: I've been having *so much fun* at home with Claude and Codex recently that I dread going back to my company's Gemini-only AI ecosystem...
