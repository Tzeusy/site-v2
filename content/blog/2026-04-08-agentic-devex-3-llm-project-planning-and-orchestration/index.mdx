...
## Repo-level check-ins

Due to the undeterministic nature of LLMs, we can rarely 'guarantee' a result; the generated code will *generally* follow the specs; the specs will *generally* follow the lore, the lore will *generally* follow the heart-and-soul. The above cycles are used for individual features; however, it's sometimes useful to run big-picture reconciliation cycles between the heart-and-soul through to the code implementation.

A recent habit of mine (and also to leverage my ChatGPT Pro subscription, I suppose) has been to launch ChatGPT Pro sessions with a dedicated custom [Project Reviewer GPT](https://chatgpt.com/g/g-69b788c0b7788191bb9f925efc1dab4d-project-reviewer) to do deep-dive 20-40 minute alignment review sessions. This often serves to identify documentation mismatch, especially when features outpace documentation as the spiderweb of implemented beads features grows. By getting it to explicitly assign scores to various categories of 'quality' for the repository, I can better inform myself of necessary directions to next take the project in.

## Conclusion

With the project-shape and the project-direction flows specced out, we now have a harness around any LLM CLI that can be used to plan and autonomously drive deep cycles of LLM work, turning brainstorming sessions of ideas into crystallized code.