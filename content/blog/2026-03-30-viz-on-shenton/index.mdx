...
Some initial experimentation (1-2 hours) looked promising, but showed that *a loooooot more work* was needed - likely on the order of weeks to months for solo-dev-me, even with LLM assistance. I hence decided to put a pin in it while focusing on the much more involved manual method of 3D modelling everything myself.

![My dream: to be able to 'dictate' instructions rather than do the 3D modelling myself](dictate-wishes.png)

I hence decided to fall back to my tried-and-true method of modelling it myself - sad but the `Technology Just Isn't There Yet`.
