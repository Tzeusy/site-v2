...
![Introduction](/blog/openai-car-racing-adventures/environment-overview.png)
...
![Neural network architecture](/blog/openai-car-racing-adventures/neural-network-architecture.png)
...
![Double Deep Q Learning](/blog/openai-car-racing-adventures/double-deep-q-learning.png)
...
![Advantage Actor-Critic](/blog/openai-car-racing-adventures/advantage-actor-critic.png)
...
![Imitation Learning](/blog/openai-car-racing-adventures/imitation-learning.png)

# Results

![REINFORCE performance](/blog/openai-car-racing-adventures/reinforce-baseline-performance.png)

*REINFORCE with Baseline: Peak mean-100 score of -200 (consistently fatal accidents)*

![Advantage Actor-Critic Performance](/blog/openai-car-racing-adventures/a2c-performance.png)

*Advantage Actor-Critic: Peak mean-100 score of -50 (One successful turn, or handles long initial stretch well)*

![DDQN with RMSProp optimizer performance](/blog/openai-car-racing-adventures/ddqn-rmsprop-performance.png)

*DDQN with RMSProp optimizer: Peak mean-100 score of 47.*

![DDQN with ADAM optimizer performance](/blog/openai-car-racing-adventures/ddqn-adam-performance.png)
...
![DDQN with Imitation Learning parameters performance](/blog/openai-car-racing-adventures/ddqn-imitation-learning-performance.png)
...
![Layer Wise Relevance Propagation Visualization](/blog/openai-car-racing-adventures/lrp-visualization.gif)
