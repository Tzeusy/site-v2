...
The Q learning algorithm was our first approach as an initial exploration of the feasibility of solving the racing car problem. We implemented Double Deep Q Learning, notably to avoid the problem of overestimation caused by traditional Q Learning. Double Q Learning uses two Q-value estimators, using each to update the other. These independent estimators hence each generate an unbiased Q-value estimate, avoiding the maximization bias of using only one Q value estimator.


![ddqn.png](/blog/openai-car-racing-adventures/openai-car-racing-adventures-3.png)
...
We also chose to try out A2C as A2C tends to be more stable than Double Q Learning. On top of that, A2C updates the model more frequently than REINFORCE. A2C rolls an episode out for *t* max steps, updates the model, then continues again. We were hoping that by doing so, our model will be able to learn quicker.


![undefined](/blog/openai-car-racing-adventures/openai-car-racing-adventures-4.png)
...
![undefined](/blog/openai-car-racing-adventures/openai-car-racing-adventures-5.png)


### Results


![reinforce_perform.png](/blog/openai-car-racing-adventures/openai-car-racing-adventures-6.png)


*REINFORCE with Baseline: Peak mean-100 score of -200 (consistently fatal accidents)*


![a2c_perform.png](/blog/openai-car-racing-adventures/openai-car-racing-adventures-7.png)


*Advantage Actor-Critic: Peak mean-100 score of -50 (One successful turn, or handles long initial stretch well)*


![ddqnrmsprop.png](/blog/openai-car-racing-adventures/openai-car-racing-adventures-8.png)


*DDQN with RMSProp optimizer: Peak mean-100 score of 47.*


![undefined](/blog/openai-car-racing-adventures/openai-car-racing-adventures-9.png)
...
![imitate_perform.png](/blog/openai-car-racing-adventures/openai-car-racing-adventures-10.png)
