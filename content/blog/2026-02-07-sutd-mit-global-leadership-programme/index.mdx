...
The challenge was to build a fully functional single-passenger electric boat from scratch in seven weeks as part of the SUTD-MIT Global Leadership Programme. The boat had to float, advance at reasonable speed on the Charles River, fit inside the IDC freight elevator, and be transportable to the MIT Sailing Pavilion. Each team received two 40 lb 12V lead-acid batteries and a range of motors and propellers to choose from.

Our team settled early on a hydrofoil boat — wing-shaped foils mounted beneath the hull to generate lift at speed. We defined success as achieving any measurable lift from the foils, however small. Full flight (hull clearing the water) was the stretch goal.

We built two fiberglass-strengthened foam hydrofoils attached by metal struts to a wooden hull, powered by a 24V outboard electric drivetrain with bevel gears. On race day the boat gained a few inches of lift before the motor shaft coupling snapped, ending the run.
...
![](./sketch-catamaran-hydrofoil.png)
...
![](./hull-dimensions-side.png)![](./hull-dimensions-top.png)![](./hull-dimensions-isometric.png)
...
![](./foil-layout-options.png)![](./foil-layout-options.png)![](./foil-layout-rounded-v.png)
...
![](./foil-design-final.png)

*CAD model of hydrofoils:*

![](./hydrofoils-cad-underside.png)

We used the H105 hydrofoil profile from [airfoiltools.com](http://airfoiltools.com), optimised for low-velocity water (low Reynolds number). At our target velocity of 6.35 knots, standard concerns like cavitation were minimal. Details on the H105: [foils.org/hysecdes.pdf](http://www.foils.org/hysecdes.pdf).
...
![](./drivetrain-labelled.png)![](./drivetrain-front-view.png)![](./drivetrain-side-view.png)
...
*Circuit diagram of initial electronics setup:*
...
![](./rudder-v1-photo.png)![](./rudder-v1-cad.png)
...
![](./rudder-v3-rear-detail.png)![](./rudder-v3-handle-detail.png)![](./rudder-v3-overview.png)
...
At 24V, 100A, and motor efficiency of 0.877, motor power is 2.1 kW — comfortably exceeding the ~1 kW drag power. This confirmed the boat could theoretically reach the 6.22 knots required for hydrofoil lift.
...
![](./shopbot-birch-layout.png)

![](./shopbot-okoume-layout-1.png) ![](./shopbot-okoume-layout-2.png)
...
Nevertheless it was a fantastic learning experience and the low-stakes, high-experimentation, and amazing group of friends made this a really enjoyable experience, and one that I'll have lots of fond memories of! We shot for the moon and missed, but the stars made for a great view :)
