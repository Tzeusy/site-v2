    ...
    <article className="space-y-12">
      <section className="space-y-4">
        ...
        <p className="max-w-[65ch] text-pretty text-lg text-muted">
          ...
          Engineer working in Citadel&apos;s Enterprise Data team. I hope you learn
      ...
      <nav className="space-y-4 border-y border-rule py-8">
        ...
        <p className="text-muted">
          <Link href="/productivity">Productivity</Link> for tools, workflows, and
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted">
          <Kbd shortcut="_" /> to cycle weather effects (just for fun!).
        </p>
      </section>
    </article>
  );
